  ...
  return (
    <div style={{ padding: 10 }} className="Sidebar">
      <div className="sidebar-container">
        ...
        <p>The pool contract can be found at <a href="https://ropsten.etherscan.io/address/0x26eAAFb64Ccc6f07473Abf844284e84649DdE3d4" target="_blank" >{props.pool_address}</a></p>
        <div>
          <div>
